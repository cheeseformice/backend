...
tar -czvf ~/$filename /var/lib/mysql/${MYSQL_DATABASE}/{auth*,member_changelog*,player_changelog*,player_privacy*,roles*,sanctions*,tribe_changelog*,tribe_privacy*,tribe_stats_changelog*}
compressed=$(date +%s)
